...
@Properties({ @Property(name = "service.description", value = "Prefix Test Servlet Minus One"),
		...
		@Property(name = "sling.servlet.paths", value = { "/servlet/service/newsPaperContainer" }),
...
public class newsPaperContainer extends SlingAllMethodsServlet {
		...
		PrintWriter out=response.getWriter();
	       ...
	       try {
	  		...
	  		try {
	  			...
	  			RequestDispatcher dis= request.getRequestDispatcher("/content/static/.docwebsite");
